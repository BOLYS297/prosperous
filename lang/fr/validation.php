...
/*
|--------------------------------------------------------------------------
| Lignes de langage de validation (français)
|--------------------------------------------------------------------------
|
| L'application est intégralement en français (APP_LOCALE=fr). Sans ce
| fichier, chaque erreur de validation s'affichait en clé technique brute
| (« validation.unique », « validation.required », ...) au lieu d'un message
| lisible. La section « attributes » traduit le nom des champs pour que les
| messages nomment les libellés métier plutôt que les colonnes de la base.
|
*/
...
return [
    ...
    */
    'custom' => [
        'nom_utilisateur' => [
            'unique' => "Ce nom d'utilisateur est déjà pris. Choisissez-en un autre.",
        ],
        'email' => [
    ...
    */
    'attributes' => [
        ...
        'horaires' => 'tranches horaires',
        'boutique_id' => 'point de vente',
        'grossiste_id' => 'grossiste',
        'mecanicien_id' => 'mécanicien',
        'fournisseur_id' => 'fournisseur',
        'produit_id' => 'produit',
        'destination_boutique_id' => 'point de vente de destination',
        'source_boutique_id' => 'point de vente source',
        'nom' => 'nom',
        'reference' => 'référence',
        'code' => 'code',
        'contact' => 'contact',
        ...
        'prix_vente_grossiste' => 'prix de vente grossiste',
        'prix_vente_hors_heures' => 'prix hors heures',
        'image' => 'image',
        'logo' => 'logo',
        'banner' => 'bannière',
        'montant' => 'montant',
        ...
        'intitule' => 'intitulé',
        'photo_justificatif' => 'justificatif',
        'quantite' => 'quantité',
        'quantite_demandee' => 'quantité demandée',
        'quantite_expediee' => 'quantité expédiée',
        'quantite_recue' => 'quantité reçue',
        'note_probleme' => 'note de problème',
        'statut' => 'statut',
        ...
        'company_immatriculation' => 'immatriculation',
        'company_address' => 'adresse',
        'company_phone' => 'téléphone',
        'currency' => 'devise',
        'ticket_footer' => 'pied de ticket',
        'majoration_hors_heures_percent' => 'pourcentage de majoration hors heures',
        'mecanicien_commission_percent' => 'commission mécanicien par défaut',
        'date' => 'date',
        'mois' => 'mois',
        'annee' => 'année',
        'period' => 'période',
        ...
        'is_grossiste' => 'vente grossiste',
        'source_type' => 'source',
        'source_id' => 'source',
        'vendu_a' => 'date de vente',
    ],
];
